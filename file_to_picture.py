...
data_values = list(binary_data)
print("Reordering color values for usage...")
color_tuples = [tuple(data_values[i:i+3]) for i in range(0, len(data_values), 3)]
...
num_pixels = math.ceil(len(data_values) / 3)
